...
CREATE TABLE "folders" (
  ...
  CONSTRAINT "folders_parent_folder_id_fkey"
    FOREIGN KEY ("parent_folder_id") REFERENCES "folders"("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "upload_items" (
  ...
  CONSTRAINT "upload_items_batch_id_fkey"
    FOREIGN KEY ("batch_id") REFERENCES "upload_batches"("id") ON DELETE CASCADE ON UPDATE CASCADE,
